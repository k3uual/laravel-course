                    ...
                    @foreach ($posts as $post)
                        ...
                        <div class="flex bg-neutral-primary-soft block border border-default rounded-base shadow-xs mb-8">
                            <div class="p-6 text-center flex-1">
                                <span class="text-white inline-flex items-center bg-brand-softer border border-brand-subtle text-fg-brand-strong text-xs font-medium px-1.5 py-0.5 rounded-sm">
                                ...
                                <a href="#">
                                    <h5 class="mt-3 mb-6 text-2xl font-semibold text-white tracking-tight text-heading">
                                        {{  $post->title  }}
                                    </h5>
                                </a>
